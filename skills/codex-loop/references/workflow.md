...
- `daemon start --retry-blocked --cycle-sleep-seconds 60 [--max-cycles N]` for launching that continuous worker in the background
- `daemon status [--json]` for checking pid, heartbeat phase, cycle, and log path
