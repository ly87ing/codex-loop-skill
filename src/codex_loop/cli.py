...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.command == "init":
            ...
            print( "  2. Confirm verification.commands in codex-loop.yaml matches how you run your tests:")
            print( "       cat codex-loop.yaml")
            print( "     The key field to check:")
            ...
            print( "  3. Commit the generated files so Codex can see them in its isolated worktree:")
            ...
            print( "  4. Run:  codex-loop run")
            print()
            print( "Before running step 4, also make sure:")
            print( "  - Codex trusts this directory AND the worktree parent.")
            print( "    Add BOTH paths to ~/.codex/config.toml (create the file if it does not exist):")
