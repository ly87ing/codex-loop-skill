...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.command == "init":
            ...
            print( "     Examples: \"python -m pytest tests/ -q\", \"npm test\", \"go test ./...\"")
            print( "     (codex-loop.yaml uses JSON syntax, not YAML indentation — that is normal.)")
            print( "     Tip: run the verification command manually now to confirm it works.")
